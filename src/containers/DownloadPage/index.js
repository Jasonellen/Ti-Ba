...
export default class DownloadPage extends Component{
	state={
		plainOptions:[
			{ label: '密封线1', value: 'Apple' },
			{ label: '大题评分区', value: 'Pear' },
			{ label: '主标题', value: 'Orange' },
		],
		...
		return (
			<div className='DownloadPage contentCenter clearfix'>
				<div className="left leftBar">
			        ...
			        <Radio value={1}>简易模办</Radio>
			        <Radio value={2}>普通模板</Radio>
			        <Radio value={3}>正式模板</Radio>
			      </RadioGroup>
					</div>
					<div className="checkgroup pad">
						<CheckboxGroup options={this.state.plainOptions} value={['Pear']} />
					</div>
				...
				<div className="right rightContent clearfix">
					<div className="left editing"></div>
					<div className="right rightpage">
						<div style={{textAlign:'center'}}><h1 contentEditable>2017年江苏省泰州市中考数学试卷</h1></div>
						<div style={{textAlign:'center'}}><h2 contentEditable>数学考试</h2></div>
            <div className="test-time">
							考试时间：<span contentEditable className='total_time'>* *</span>分钟 <span contentEditable>* *</span>分
            </div>
            ...
            <table className="top_table">
            	<tbody>
				    ...
				    <div className="warning">
							<p>* 注意事项：</p>
							<div className="warningText" contentEditable>
								1、填写答题卡的内容用2B铅笔填写<br/>
								2、提前 xx 分钟收取答题卡;
							</div>
				    </div>
				    <div style={{textAlign:'center',marginTop:10}} className='clearfix'>
				    	<small className="left" style={{color:'#999'}} contentEditable>第Ⅰ卷的注释</small>
				    	<h3 contentEditable>第Ⅰ卷 客观题</h3>
				    </div>
				    <div className="paper-types">
					    ...
					    <p>
					    	<strong>
					    		...
					    		、<span contentEditable>解答题</span>
					    		<span>(共<b className="t-num">2</b>题；共<b className="t-score">20</b>分)</span>
					    	</strong>
					    </p>
